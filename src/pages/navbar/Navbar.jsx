...
const Navbar = () => {
  ...
  return (
    <div className="navbar flex items-center  mx-auto max-w-[1400px] bg-black bg-opacity-70 px-7 h-24 inset-x-0 top-0 absolute z-20">
      <div className="lg:w-1/2 flex-col lg:flex-row text-white">
        ...
        <a className="btn btn-ghost normal-case text-4xl" style={colorText}>
          EventifyEDU
        </a>
      </div>
      ...
      <div className="w-1/2 flex flex-row justify-end text-white p-2 gap-3">
        {user ? (
          <>
            <img
